...
class PageCrudController extends CrudController
{
    ...
    {   
      $this->crud->addColumn([
          'name' => 'title',
          'label' => trans('ak_pages::pages.name'),
      ]);
      
      $this->crud->addColumn([
          'name' => 'template',
          'label' => trans('ak_pages::pages.template'),
          'type' => 'model_function',
      ...
      $this->crud->addColumn([
          'name' => 'slug',
          'label' => trans('ak_pages::pages.slug'),
      ]);
    ...
    public function addDefaultPageFields($template = false)
    {
      ...
      $this->crud->addField([
        'name' => 'is_active',
        'label' => trans('ak_pages::pages.page_is_active'),
        'type' => 'checkbox',
        'tab' => 'Основное'
      ]);
      ...
      $this->crud->addField([
        'name' => 'title',
        'label' => trans('ak_pages::pages.page_title'),
        'type' => 'text',
        'tab' => 'Основное'
      ]);
      ...
      $this->crud->addField([
        'name' => 'slug',
        'label' => trans('ak_pages::pages.page_slug'),
        'type' => 'text',
        'hint' => trans('ak_pages::pages.page_slug_hint'),
        'tab' => 'Основное'
      ]);
      ...
      $this->crud->addField([
        'name' => 'meta_title',
        'label' => trans('ak_pages::pages.meta_title'),
        'fake' => true,
        'store_in' => 'seo',
        'tab' => 'SEO'
      ]);
      ...
      $this->crud->addField([
        ...
        'label' => trans('ak_pages::pages.meta_description'),
        'type' => 'textarea',
        'fake' => true,
        'store_in' => 'seo',
        'tab' => 'SEO'
